...
void st11::choose_position( int &x , int &y )
{
    int inf = 1000000000;
    double maxs = -inf ;
    for ( int i = 1 ; i <= N ; ++i )
...
void st11::EnemyInformation_Update()
{
    for ( int i = 1 ; i <= N ; ++i )
        for ( int j = 1 ; j <= M ; ++j )
...
//  -----------------------------------------------     //
//  my update
void st11::MyInformation_Update()
{
...
int st11::Find_Food( int addition )
{
    int res = 0 ;
    for ( int i = 1 ; i <= N ; ++i )
        for ( int j = 1 ; j <= M ; ++j )
